...
(function() {
  var $, $canvas, applePos, appleTimeout, applesCollected, clearBackground, context, currentAppleType, currentGameIntervalRate, drawApple, drawDeadScreen, drawSnake, dx, dy, endGame, gameBoardWidth, gameInterval, gameState, generateNewRandomPosition, gridPosToCanvasPos, gridSize, highScore, initGame, initGameLoop, moveSnake, numColumns, numRows, positionApple, positionCollidesWithSnake, score, snake, snakePiecesLeftToAdd, startingGameIntervalRate, tick, updateScore;
  ...
  initGame = function() {
    ...
    return initGameLoop(startingGameIntervalRate);
  };
  ...
  initGameLoop = function(spd) {
    console.log("SPD " + spd);
    clearInterval(gameInterval);
    return gameInterval = setInterval(function() {
      return tick();
    }, spd);
  };
