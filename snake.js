...
(function() {
  var $, $canvas, applePos, clearBackground, context, drawApple, drawDeadScreen, drawSnake, dx, dy, endGame, gameBoardWidth, gameState, generateNewRandomPosition, gridPosToCanvasPos, gridSize, highScore, initGame, moveSnake, numColumns, numRows, positionApple, positionCollidesWithSnake, score, snake, tick, updateScore;
